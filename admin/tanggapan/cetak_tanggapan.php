...
<div class="header">
    <img src="https://i.ibb.co/gP2Z797/logo.png" alt="logo" class="logo" style="margin-right: 10px;">
    <div class="name">
        <p style="font-weight: bold; font-size: 30px; margin: 0;">BENGKEL MOBIL DANPRAD</p>
        <p style="font-weight: italic; font-size: 16px; margin: 0;">Layanan berkualitas tinggi serta solusi terbaik untuk kebutuhan perawatan dan perbaikan kendaraan</p>
...
<div class="col-12">
    <div class="card">
        ...
        <style>
            ...
            /* Logo di kiri, Alamat, Telp, dan Email di tengah, dan Nama di kanan */
            .header {
                display: flex;
